...
class Receipt:
    ...
    def get_control_sum(self):
        ...
        if control_summa in Receipt.unic_control_sum.values():
            ...
            self.control_sum[self.__receipt_id] = control_summa
            Receipt.unic_control_sum.update(self.control_sum)
        return self.control_sum
...
ch_1 = f"Ваш товарный чек: {ch1.get_receipt_id()}"
print(ch_1.center(50))
...
print(f"Список товаров (бренд/цена/категория: {ch1.content_product_list(lipstick_red.add_kit(lipstick_red.name,
                                              lipstick_red.get_price(),
                                              lipstick_red.get_category()
                                              ))}")

ch_2 = f"Ваш товарный чек: {ch2.get_receipt_id()}"
print(ch_2.center(50))
